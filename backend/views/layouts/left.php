...
<aside class="main-sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="treeview">
                ...
                <ul class="treeview-menu menu-open" style="display: block;">
                    ...
                    <li><a href="<?= \yii\helpers\Url::to(['/planta/select']) ?>"><span class="fa fa-file-code-o"></span> Planta</a>
  ...
  <li class="treeview">
			...
			<a href="<?= \yii\helpers\Url::to(['/categorias'])?>"><i class="fa fa-circle-o"></i> Categorias</a>
                        <a href="<?= \yii\helpers\Url::to(['/cursosimport/create'])?>"><i class="fa fa-circle-o"></i>Importar cursos</a>
			<a href="<?= \yii\helpers\Url::to(['/cursos'])?>"><i class="fa fa-circle-o"></i> Cursos</a>
 			...
 			<a href="<?= \yii\helpers\Url::to(['/docentesimport/create'])?>"><i class="fa fa-circle-o"></i>Importar docentes</a>
...
<a href="<?= \yii\helpers\Url::to(['/resoluciones'])?>"><i class="fa fa-circle-o"></i> Resoluci&oacute;n</a>
                        <a href="<?= \yii\helpers\Url::to(['/revista'])?>"><i class="fa fa-circle-o"></i> Revista</a>
