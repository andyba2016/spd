...
//$query->andFilterWhere(['isActive'=>true]);

        $clauses = [
            $this->buildSelect($query->select, $params, $query->distinct, $query->selectOption),
            $this->buildFrom($query->from, $params,$query),
            $this->buildJoin($query->join, $params,$query),
    ...
    {
		//corbi start
		return $this->update($table, ['isActive' => false], $condition, $params);
     ...
     */
    public function buildFrom($tables, &$params,$query)
    {
        if (empty($tables)) {
            return '';
        }
...
//corbi start
//$this->tablas[]=implode(', ', $tables);//corbi
$tablaArray[] = implode(', ', $tables);
foreach($tablaArray as $singleTable){
	$query->andFilterWhere([$singleTable.'."isActive"'=>true]);
}
//corbi end
...
public $tablas=[];
    ...
    public function buildJoin($joins, &$params,$query)
    {
	...
	//[0] => "cursos"----{{planta}}.[[id_curso]] = {{cursos}}.[[id]]- ) Array ( [0] => "cursos"----{{planta}}.[[id_curso]] = {{cursos}}.[[id]]- 
	//$this->tablas[]=$table."----".$join[2]."-";

	$query->andFilterWhere([$table.'."isActive"'=>true]);
...
//		$condition[$tabla.'.isActive'] = true;

//		if(isset($condition['isActive'])) unset($condition['isActive']);
//	}
